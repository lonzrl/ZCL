...
class MinecraftLauncherGUI:
  ...
  "clientToken": "23323323323323323323323323323333"
    ...
    def create_widgets(self):
        ...
        # 标题
        title_label = ttk.Label(main_frame, text="Welcome！——ZCL(ZRL Python Minecraft Launcher)r", font=("宋体", 20))
    ...
    def load_littleskin_credentials(self):
        """从配置文件加载LittleSkin凭证"""
        try:
            settings_file = f"./zcl_settings.json"
        ...
        try:
            ...
            req = urllib.request.Request(
                ...
                headers={
                    ...
                    'User-Agent': 'ZCL(ZRL Python Minecraft Launcher)'
                }
            )
